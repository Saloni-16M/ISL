...
const NextPage = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen  p-6 next_page">
      <h1 className="text-4xl font-bold text-center mb-4 text-white-600">Let's Get Started with Sign Language Conversion!</h1>
      <div className="bg-white shadow-lg rounded-lg p-6 max-w-2xl text-left">
      ...
      <div className="mt-6 flex space-x-4">
        <button 
          ...
          className="bg-gray-400 text-white font-semibold py-2 px-4 rounded hover:bg-gray-500 transition duration-300 ease-in-out"
        >
          Previous
        </button>
        <button 
          onClick={handleNext} 
          className="bg-green-600 text-white font-semibold py-2 px-4 rounded hover:bg-teal-600 transition duration-300 ease-in-out"
        >
          Next
        </button>
      </div>
